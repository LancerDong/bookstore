...
public class PageBean {
	...
	public PageBean(int currentPage, int totalCount, int totalPage,
			int currentCount, List<Product> ps, String category) {
		super();
	...
	public String toString() {
		return "PageBean [currentPage=" + currentPage + ", totalCount="
				+ totalCount + ", totalPage=" + totalPage + ", currentCount="
				+ currentCount + ", ps=" + ps + ", category=" + category + "]";
	}
