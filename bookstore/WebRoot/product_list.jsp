			...
			<tr>
				...
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${pb.category==""?"全部商品":pb.category }&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>${pb.category==""? "全部商品":pb.category }</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pb.totalCount }种商品
								<hr />
										...
										<c:forEach items="${pb.ps }" var="b">
											<td>
												...
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath }/FindBookInfoServlet?id=${b.id}">书名:${b.name
														}<br/>售价:${b.price } </a>
												</div>
											</td>
										</c:forEach>
